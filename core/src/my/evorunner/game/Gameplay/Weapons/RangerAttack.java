...
public class RangerAttack extends Weapon {
    ...
    public RangerAttack(Vector2 position) {
        this.position = position;
        region = Assets.ourInstance.arrowAssets.ARROW_0;
    ...
    public void update(float delta, DelayedRemovalArray<Enemy> enemies) {
        ...
        if(usedState == UsedState.AVAILABLE) {
            region = (TextureRegion) Assets.ourInstance.arrowAssets.arrowRotationAnimation.getKeyFrame(throwTimeKeeper);
        } else {
