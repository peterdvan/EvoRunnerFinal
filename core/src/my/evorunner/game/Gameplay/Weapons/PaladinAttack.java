...
public class PaladinAttack extends  Weapon{
    ...
    public PaladinAttack(Vector2 position) {
        this.position = position;
        region = Assets.ourInstance.paladinAssets.explosion0;
    ...
    public void update(float delta, DelayedRemovalArray<Enemy> enemies) {
        ...
        region = (TextureRegion) Assets.ourInstance.paladinAssets.explosionAnimation.getKeyFrame(throwTimeKeeper);
    }
    ...
    public boolean isFinished() {
        return Assets.ourInstance.paladinAssets.explosionAnimation.isAnimationFinished(throwTimeKeeper);
    }
