...
public class MonkAttack extends Weapon {
    ...
    public MonkAttack(Vector2 position) {
        this.position = position;
        region = Assets.ourInstance.boomerangAssets.boomerang0;
    ...
    public void update(float delta, DelayedRemovalArray<Enemy> enemies) {
        ...
        if(usedState == UsedState.AVAILABLE) {
            region = (TextureRegion) Assets.ourInstance.boomerangAssets.boomerangAnimation.getKeyFrame(throwTimeKeeper);
        } else {
